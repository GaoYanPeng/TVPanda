package com.gaoyanpeng.tvpanda.view.searchview.anim.controller;
...
public class JJCircleToSimpleLineController extends JJBaseController {
    ...
    private void drawStopAnimView(Paint paint, Canvas canvas) {
        ...
        canvas.restore();
        mRectF.left = cx - cr + 290 * (1 - mPro);
        mRectF.right = cx + cr + 290 * (1 - mPro);
        mRectF.top = cy - cr;
        mRectF.bottom = cy + cr;
    }
    ...
    private void drawStartAnimView(Paint paint, Canvas canvas) {
        ...
        mRectF.left = cx - cr + 290 * mPro;
        mRectF.right = cx + cr + 290 * mPro;
        mRectF.top = cy - cr;
        mRectF.bottom = cy + cr;
    }
...
//        #55a381
        paint.setColor(Color.rgb(0x34,0x49,0x49));
